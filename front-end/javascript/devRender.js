...
<section class="developer-info-box">
    <a class="bio-anchors" href="http://jgibson37.github.io" target="_blank">Jason Gibson's Portfolio</a>
    <a class="bio-anchors" href="http://www.linkedin.com/in/jgibson37" target="_blank">Jason Gibson's LinkedIn</a>
...
const renderMiles = () => {
  ...
  selectDevBox.innerHTML = `            
    ...
    <section class="developer-info-box">
        <a class="bio-anchors" href="http://milesshank.github.io" target="_blank">Miles Shank's Portfolio</a>
        <a class="bio-anchors" href="http://www.linkedin.com/in/miles-shank" target="_blank">Miles Shank's LinkedIn</a>
        <p class="bio-info">Strengths:</p>
        <ul>
...
const renderKenny = () => {
  ...
  selectDevBox.innerHTML = `
    ...
    <section class="developer-info-box">
        <a class="bio-anchors" href="http://kennycreates.github.io" target="_blank">Kenny Williams's Portfolio</a>
        <a class="bio-anchors" href="http://www.linkedin.com/in/kenny-williams-c" target="_blank">Kenny Williams's LinkedIn</a>
        <p class="bio-info">Strengths:</p>
        <ul>
...
const renderTrey = () => {
  ...
  selectDevBox.innerHTML = `            
    ...
    <section class="developer-info-box">
        <a class="bio-anchors" href="http://joetreygrace.github.io" target="_blank">Trey Grace's Portfolio</a>
        <a class="bio-anchors" href="http://www.linkedin.com/in/trey-grace" target="_blank">Trey Grace's LinkedIn</a>
        <p class="bio-info">Strengths:</p>
        <ul class="skill-ul">
          <li><span class="skill-span"> Java: <div class="skill-bar-1">0000000000000</div> </span></li>
          <li><span class="skill-span"> Html: <div class="skill-bar-2">00000000000</div></span></li>
...
const renderSarah = () => {
  ...
  selectDevBox.innerHTML = `  
    ...
    <section class="developer-info-box">
        <a class="bio-anchors" href="http://sgreene807.github.io" target="_blank">Sarah Greene's Portfolio</a>
        <a class="bio-anchors" href="http://www.linkedin.com/in/greene-sarah" target="_blank">Sarah Greene's LinkedIn</a>
        <p class="bio-info">Strengths:</p>
        <ul>
          <li><span class="skill-span"> Java: <div class="skill-bar-1">0000000000000</div> </span></li>
          <li><span class="skill-span"> Html: <div class="skill-bar-2">000000000000</div></span></li>
...
const renderJd = () => {
  ...
  selectDevBox.innerHTML = `           
    ...
    <section class="developer-info-box">
        <a class="bio-anchors" href="http://patchesohoolihan.github.io" target="_blank">JD King's Portfolio</a>
        <a class="bio-anchors" href="http://www.linkedin.com/in/gale-king" target="_blank">JD King's LinkedIn</a>
        <p class="bio-info">Strengths:</p>
        <ul>
          <li><span class="skill-span"> Java: <div class="skill-bar-1">0000000000000</div> </span></li>
